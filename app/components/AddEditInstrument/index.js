    ...
    <>
      <View style={styles.row}>
            ...
            <View style={[AppStyles.mainInputWrap]}>
              <View style={[AppStyles.inputWrap]}>
                <PickerComponent
                  ...
                  placeholder={
                    instrumentNumbers && instrumentNumbers.length > 0
                      ? 'Select Instrument Number'
                      : 'No Option Available'
                  }
                  selectedItem={instrument.id}
                />
              </View>
            </View>
          ) : (
        ...
        {manualInstrumentSelect ? (
          <TouchableOpacity
            disabled={!enabled}
            style={[styles.row, { width: '25%', justifyContent: 'center' }]}
            onPress={() => {
              dispatch(
          ...
          <TouchableOpacity
            disabled={!enabled}
            style={[styles.row, { width: '25%', justifyContent: 'space-between' }]}
