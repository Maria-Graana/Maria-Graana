export default StaticData = {
    ...
    investmentFilter: [
        ...
        { value: 'no_response', name: 'Call: No Response' },
        { value: 'powered_off', name: 'Call: Powered Off' },
        { value: 'invalid_number', name: 'Call: Invalid Number' },
        { value: 'follow_up', name: 'Call: Follow-up' },
        { value: 'awaiting_response', name: 'Call: Awaiting Response' },
        { value: 'details_sent', name: 'Call: Details Sent' },
        { value: 'expected_visit', name: 'Call: Expected Visit' },
        { value: 'not_interested', name: 'Call: Not Interested' },
        { value: 'payments', name: 'Meeting: Payments' },
        { value: 'closed', name: 'Meeting: Closed' },
        { value: 'visited', name: 'Meeting: Visited' },
        { value: 'expected_conversion', name: 'Meeting: Expected Conversion' },
        { value: 'deal_signed', name: 'Meeting: Deal Signed' },
        { value: 'cancel_meeting', name: 'Meeting: Cancel Meeting' },
    ],
    cmLeadBtnOption: [
