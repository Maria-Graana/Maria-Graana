...
export default StaticData = {
  ...
  commentsFeedbackCall:[
    ...
    { value: 'no_response_details_shared', name: 'No Response But Details Shared', colorCode:  '#FEC107' },
    { value: 'details_shared_via_whatsapp_sms_email', name: 'Details Shared via WhatsApp/SMS/Email', colorCode: '#FEC107' },
    { value: 'will_get_back_if_interested', name: 'Will get back if interested', colorCode: '#FEC107' },
    ...
    { value: 'will_interact_via_whatsapp_sms_email ', name: 'Will Interact via WhatsApp/SMS/Email', colorCode:  '#FEC107' },
    { value: 'asked_to_call_back_later', name: 'Asked to Call back later', colorCode:  '#FEC107' },
    { value: 'asked_to_share_details_via_whatsapp_sms_email', name: 'Asked to Share Details via Whatsapp/SMS/Email', colorCode:  '#FEC107' },
    ...
    { value: 'not_interested_out_of_city', name: 'Not Interested - Out of City', colorCode: '#DC3546' },
    { value: 'not_interested_re_only', name: 'Not Interested - Interested in RE Only', colorCode: '#DC3546' },
    { value: 'interested_in_projects_in_other_city', name: 'Interested in Projects in Other City', colorCode: '#DC3546'},
    { value: 'not_interested_low_budget', name: 'Out of clients budget/preference', colorCode:'#DC3546' },
