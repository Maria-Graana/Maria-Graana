...
export default StaticData = {
  ...
  commentsFeedback:[
    ...
    { value: 'no_response_details_shared', name: 'No Response But Details Shared', colorCode: '#FDD835' },
    { value: 'details_shared_via_whatsapp_sms_email', name: 'Details Shared via WhatsApp/SMS/Email', colorCode: '#FDD835' },
    { value: 'will_get_back_if_interested', name: 'Will get back if interested', colorCode: '#FDD835' },
    ...
    { value: 'will_interact_via_whatsapp_sms_email ', name: 'Will Interact via WhatsApp/SMS/Email', colorCode: '#FDD835' },
    { value: 'asked_to_call_back_later', name: 'Asked to Call back later', colorCode: '#FDD835' },
    { value: 'asked_to_share_details_via_whatsapp_sms_email', name: 'Asked to Share Details via Whatsapp/SMS/Email', colorCode: '#FDD835' },
    ...
    { value: 'not_interested_re_only', name: 'Not Interested - Interested in RE Only', colorCode: 'red' },
    { value: 'interested_in_projects_in_other_city', name: 'Interested in Projects in Other City', colorCode: 'red' },
    { value: 'not_interested_low_budget', name: 'Out of clients budget/preference', colorCode: 'red' },
