                ...
                <SafeAreaView style={[AppStyles.mb1, {}]}>
                    <View style={{ flexDirection: 'row', marginHorizontal: 10, justifyContent: "space-between" }}>
                        ...
                        <TouchableOpacity onPress={() => this.submit()}>
                            <Text style={{ paddingTop: 10, fontSize: 16, fontFamily: AppStyles.fonts.defaultFont }}>
                                Done
                        </Text>
                        </TouchableOpacity>
                    </View>
                    <View style={[AppStyles.container, { paddingHorizontal: 10, backgroundColor: AppStyles.bgcWhite.backgroundColor }]}>
