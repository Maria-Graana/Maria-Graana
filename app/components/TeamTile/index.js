...
class TeamTile extends React.Component {
  ...
  render() {
    ...
    const organizationName =
      item && item.organization && item.organization.name ? item.organization.name : ''
    ...
    return (
      ...
      >
        <View
          style={
            selected && item && item.id === selectedId ? styles.selectedStyle : styles.simpleStyle
          }
        >
          <View style={{ paddingRight: 10 }}>{item && <Avatar data={item} />}</View>
              ...
              {organizationName !== '' ? (
                <Text
                  style={[
                    ...
                    {
                      fontSize: 18,
                      color: organizationName === 'Graana' ? 'red' : 'green',
                      width: '20%',
                      textAlign: 'right',
                    },
                  ]}
