    ...
    render() {
        ...
        return (
            <View style={[AppStyles.mb1]}>
                <DashboardTile image={investmentReportTile} label={'CMReport'} navigateTo={this.navigateTo}/>
                <DashboardTile image={buyrentReportTile} label={'RCMReport'} navigateTo={this.navigateTo} />
            </View>
